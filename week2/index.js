...
console.log(i + j === '99'); // ture
console.log(i + j === 99); // false

var k = 3;
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21); // true k * j j 會自動轉型成數字型別，所以 3 * 8 等於 24 > 21 是 true
...
const gymCoach = [
  {
    ...
    specialty: '力量訓練、減重課程',
    classes: {
      oneOnOne: '個人訓練課程：每次收費 2000 元，課程時長 60 分鐘，目前有空堂。',
      group: '團體訓練課程：每次收費 1500 元，課程時長 90 分鐘，目前無空堂。'
    },
  ...
  },
  {
    ...
    specialty: '瑜伽、體態雕塑',
    classes: {
      oneOnOne: '每次收費 1800 元，課程時長 50 分鐘，目前無空堂。',
      group: '每次收費 1200 元，課程時長 75 分鐘，目前有空堂。'
    },
...
let calorieBurn = 0;
calorieBurn = (activities.bicycle.caloriesBurnedPerMinute * 10) + (activities.treadmill.caloriesBurnedPerMinute * 30) + (activities.yoga.caloriesBurnedPerMinute * 40) + (activities.bicycle.caloriesBurnedPerMinute * 10)
